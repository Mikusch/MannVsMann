...
ConVar sm_mvm_currency_player_killed;
ConVar sm_mvm_currency_objective_captured;
ConVar sm_mvm_currency_escort;
ConVar sm_mvm_currency_player_count_base;
ConVar sm_mvm_currency_player_count_bonus_min;
ConVar sm_mvm_currency_player_count_bonus_max;
ConVar sm_mvm_currency_team_catchup_min;
ConVar sm_mvm_currency_team_catchup_max;
ConVar sm_mvm_currency_team_catchup_base_threshold;
ConVar sm_mvm_currency_team_catchup_threshold_scale;
ConVar sm_mvm_currency_team_catchup_multiplier_strength;
ConVar sm_mvm_currency_modifier_arena;
ConVar sm_mvm_currency_modifier_medieval;
