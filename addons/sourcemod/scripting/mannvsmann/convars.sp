...
void ConVars_Init()
{
	...
	sm_mvm_currency_modifier_arena = CreateConVar("sm_mvm_currency_modifier_arena", "1.66", "Multiplier to dropped currency in arena mode.");
	sm_mvm_currency_modifier_medieval = CreateConVar("sm_mvm_currency_modifier_medieval", "0.33", "Multiplier to dropped currency in medieval mode.");
